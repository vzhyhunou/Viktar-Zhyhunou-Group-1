...
public class App
{
    ...
    public static  void loadFromJar() throws  Exception{
        ...
        Class clazz = Class.forName("com.epam.darafeyeu.ClassToLoadImpl", true, loader);
        ClassToLoad object = (ClassToLoad) clazz.newInstance();
